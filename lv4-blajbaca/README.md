...
Napravljene funkcionalnosti samo za 1 bod. Bazu podataka potrebno je ručno kreirati unutar php admin dashboarda kao što je priloženo unutar setup.sql datoteke.  
Slike proizvoda su prilozene unutar assets direktorija.
Alternativno, prilozena je skripta setupDatabase.php koja bi teoretski trebala napraviti i bazu podataka i tablicu za ispravan rad stranice.
